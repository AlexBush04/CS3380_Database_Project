...
### Run Application
Open the GUI_interface.py file in a Python instance and run it. A user interface should open up and allow you to interact with the database. If you open up the Application_functions.py file and look in
